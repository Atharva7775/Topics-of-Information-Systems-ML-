...
class ParameterPool(Enum):
    RANDOM = Parameter(stages=[1, 100], cores=[[1, 1], [1, 1]], train_steps=[2000, 2000],
                       batch_sizes=[50, 50], learning_rates=[0.001, 0.001], keep_ratios=[0.5, 0.5])
    ...
    LOGNORMAL = Parameter(stages=[1, 100], cores=[[1, 16, 16, 1], [1, 8, 1]], train_steps=[2000, 400],
                          batch_sizes=[100, 50], learning_rates=[0.001, 0.001], keep_ratios=[1.0, 0.9])
    EXPONENTIAL = Parameter(stages=[1, 100], cores=[[1, 8, 1], [1, 8, 1]], train_steps=[30000, 20000],
                            batch_sizes=[50, 50], learning_rates=[0.3, 0.3], keep_ratios=[0.9, 1.0])
    ...
    BINOMIAL = Parameter(stages=[1, 100], cores=[[1, 8, 1], [1, 8, 1]], train_steps=[20000, 300],
                       batch_sizes=[50, 50], learning_rates=[0.2, 0.2], keep_ratios=[0.9, 1.0])
    POISSON = Parameter(stages=[1, 100], cores=[[1, 8, 1], [1, 8, 1]], train_steps=[20000, 300],
                         batch_sizes=[50, 50], learning_rates=[0.001, 0.001], keep_ratios=[0.9, 1.0])
    UNIFORM = Parameter(stages=[1, 100], cores=[[1, 8, 1], [1, 8, 1]], train_steps=[20000, 300],
                         batch_sizes=[100, 100], learning_rates=[0.001, 0.001], keep_ratios=[0.9, 1.0])
