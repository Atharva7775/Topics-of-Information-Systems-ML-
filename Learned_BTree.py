...
thresholdPool = {
    ...
    Distribution.UNIFORM: [55, 10000, 10000],
...
useThresholdPool = {
    ...
    Distribution.UNIFORM: [False, False, True],
}
...
def train_index(threshold, use_threshold, distribution, path):
    ...
    if distribution == Distribution.RANDOM:
        ...
        parameter = ParameterPool.UNIFORM.value
    else:
        return
    ...
    print("number of lookups: {}".format(len(test_set_x)))
    print("Search time %f " % search_time)
    print("Search time total %f " % search_time_total)
